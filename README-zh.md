...
sudo docker-compose -f https://github.com/apache/couchdb-docker --env-file .env up -d
```
...
修改 [docker-compose](https://github.com/apache/couchdb-docker) 文件中冲突的端口，然后再启动容器
