...
| --- | --- | --- | --- |
| couchdb | 5984 | Accessing CouchDB database with TCP | Y |
## Documentation

[CouchDB Administrator Guide](https://support.websoft9.com/docs/couchdb)

## Enterprise Support

If you want to get our Enterprise Support to ensure high availability of applications, you can subscribe our [CouchDB Enterprise Support](https://apps.websoft9.com/couchdb) 
