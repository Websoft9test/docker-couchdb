...
We assume that you are already familiar with Docker, and you can modify [docker-compose file](https://github.com/apache/couchdb-docker) by yourself
...
docker-compose -f https://github.com/apache/couchdb-docker  --env-file  .env up -d
```
